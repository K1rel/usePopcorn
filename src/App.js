...
function WatchedMoviesList({ watched, handleRemoveWatched }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
        <WatchedMovie
  ...
  return (
    <div className="details">
      {isLoading ? (
        ...
        <>
          <header>
            <button className="btn-back" onClick={onHandleCloseSelected}>
              &larr;
            </button>
...
export default function App() {
  ...
  // });
  const { movies, isLoading, error } = useMovies(query, handleCloseSelected);
  ...
  function removeWatched(id) {
    setWatched((watched) => watched.filter((i) => i.imdbID !== id));
  }
        ...
        <Box>
          {selectedId ? (
            ...
            <>
              ...
              <WatchedMoviesList
                watched={watched}
                handleRemoveWatched={removeWatched}
              />{" "}
            </>
          )}
        </Box>
